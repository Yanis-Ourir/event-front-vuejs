...
<template>
              <form class="flex flex-col bg-gray-900 p-10 md:p-16 rounded-2xl border border-white/20 backdrop-blur-lg shadow-lg w-full max-w-md"
                ...
                <div class="relative">
                    <input type="title" id="title" placeholder="Next.js conference"
                ...
                <div class="relative">
                    <textarea type="text" id="description" placeholder="A conference about the latest in Next.js development."
                        class="bg-gray-800 w-full rounded-lg px-4 py-2 border border-gray-700 focus:ring-2 focus:ring-violet-500 focus:outline-none transition-all" />
                </div>

                <label for="date" class="text-gray-300 mt-4 mb-2">Date</label>
                <div class="relative">
                    <input type="date" id="date" placeholder="2023-10-15"
                        class="bg-gray-800 w-full rounded-lg px-4 py-2 border border-gray-700 focus:ring-2 focus:ring-violet-500 focus:outline-none transition-all" />
                </div>
                ...
                <div class="relative">
                    <input type="location" id="location" placeholder="London, United Kingdom"
                        class="bg-gray-800 w-full rounded-lg px-4 py-2 border border-gray-700 focus:ring-2 focus:ring-violet-500 focus:outline-none transition-all" />
                </div>
